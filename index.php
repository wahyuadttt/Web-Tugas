...
<body>
            ...
            <aside class="calendar-sidebar">
                ...
                <div class="calendar-grid">
                    ...
                    <div class="calendar-days">
                        ...
                        // Hitung hari pertama (0 = Sunday, 6 = Saturday)
                        ...
                        $endDay = ($startDay + $lastDay->format('d')) % 7;
                        if ($endDay > 0) {
                            $remainingDays = 7 - $endDay;
            ...
            <main class="tasks-area">
                <div class="tasks-grid">
                    ...
                    <div class="task-card" data-task-id="<?= $tugas['id'] ?>">
                        ...
                        <div class="task-meta">
    <span class="task-date-label">Deadline:</span>
    <span class="task-date-value">
        <?= date('d-m-Y', strtotime($tugas['deadline_date'])) ?> (<?= date('H:i', strtotime($tugas['deadline_time'])) ?>)
    </span>
</div>
    ...
    <img src="<?= htmlspecialchars($gambar) ?>" alt="Gambar Tugas" onclick="openImageModal('<?= htmlspecialchars($gambar) ?>')" style="cursor: pointer;">
</div>
                                <?php 
                                        endif;
                                    endforeach;
                    ...
                    <div class="task-card flexible" data-task-id="<?= $tugas['id'] ?>">
                        ...
                        <div class="task-meta">
                            <span class="task-date-label">Deadline: Kapan-Kapan</span>
                        </div>
